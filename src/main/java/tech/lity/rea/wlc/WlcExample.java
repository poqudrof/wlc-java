...
import org.bytedeco.javacpp.wlc;
import org.bytedeco.javacpp.wlc.Cb_Pointer_int_wlc_point;
import org.bytedeco.javacpp.wlc.wlc_point;
 ...
 * @author jiii
 */
public class WlcExample {
    
    // Wlc_handle
    Pointer current_view;
    
    public static class Motion extends Cb_Pointer_int_wlc_point {
        public void call(@ByVal @Cast("wlc_handle*") Pointer view, @Cast("uint32_t") int edges, @Const wlc_point position){
            System.out.println("Motion..." + position.x() + " " + position.y());
            wlc.wlc_pointer_set_position(position);
        }
    ...
    public static void main(String[] args) {
        ...
        boolean init = wlc.wlc_init();
        
        // function pointer -_- 
        Motion motionHandler = new Motion();
        
        wlc.wlc_set_pointer_motion_cb(motionHandler);
